        ...
        <div>
          ...
          <div className="flex gap-3 mt-6">
            <div className="border rounded-full p-2 hover:bg-white hover:text-black cursor-pointer">
              <Facebook size={16}
              onClick={()=>router.push("https://www.facebook.com/324948335046042")} />
            </div>
            <div className="border rounded-full p-2 hover:bg-white hover:text-black cursor-pointer">
              <Twitter size={16}
              onClick={()=>router.push("https://www.instagram.com/smansabangunrejo/?hl=en")} />
            </div>
            <div className="border rounded-full p-2 hover:bg-white hover:text-black cursor-pointer">
              <Youtube size={16}
              onClick={()=>router.push("https://www.youtube.com/channel/UCWwq4domYrvlazIWwi9IENQ")} />
            </div>
            <div className="border rounded-full p-2 hover:bg-white hover:text-black cursor-pointer">
              <Instagram size={16}
              onClick={()=>router.push("https://www.instagram.com/smansabangunrejo/?hl=en")}  />
